function c0 = calculate_optimal_c0(R2, R, mu_SF_1, mu_SF_2, Vmax, options, c0_init, plot_option)
...
% Vmax    : The maximum volumetric expansion permitted in the optimisation
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    optim_func = @(c0) Vmax_obj_func(c0, R2, R, mu_SF_1, mu_SF_2, Vmax, options);
    [c0, ~] = special_solve_Vmax(optim_func, c0_init, 0.0, 1.0, options, plot_option);
    
end

function res = Vmax_obj_func(c0, R2, R, mu_SF_1, mu_SF_2, Vmax, options)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Function to calculate the residual between the expansion of the hybrid
% particle with a state of charge of c0 and Vmax.
%
% Inputs
% ------
% c0      : State of charge
...
% Calculate the lithium concentration in the core and the shell
...
u = R2*eta_1*Vm_1*c_max_1*(A_2 + B_2);
...
function [output, error] = special_solve_Vmax(solve_fun, c0_init, lb, ub, options, plot_option)
    ...
    % be large due to the order in which we vary R.
    % Inputs
    % ------
    ...
    % If this solution is invalid, go to bisection
