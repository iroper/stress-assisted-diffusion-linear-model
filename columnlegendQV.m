function [legend_h,object_h,plot_h,text_strings] = columnlegendQV(numcolumns, str, varargin)
%
...
switch lower(location),
    ...
    case {'northwest'}
        set(legend_h, 'position', [pos(1)+2.2*padding pos(2) pos(3) pos(4)]);        
    case {'southeast'}
        pos(4) = newheight;
